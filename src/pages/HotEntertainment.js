...
//       image: "path/to/bollywood-gossip.jpg",
//       description:
...
//       image: "path/to/celebrity-fashion.jpg",
//       description:
...
//       image: "path/to/music-awards.jpg",
//       description:
...
//         <div className="absolute inset-0 bg-gradient-to-b from-black via-neonGreen to-black opacity-70 mt-5"></div>
  ...
  return (
    <div className="bg-blackBg min-h-screen">
      ...
      <section className="relative bg-blackBg py-24 sm:py-24 text-center">
        ...
        <div className="relative z-10 text-neonGreen px-4">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold mb-4 sm:mb-6 animate-glow">
            Hot Entertainment
          </h1>
          <p className="text-white text-base sm:text-lg md:text-xl mb-6 sm:mb-10 max-w-2xl mx-auto">
            Stay updated on the latest glamour, fashion, and entertainment from Bollywood and Hollywood.
